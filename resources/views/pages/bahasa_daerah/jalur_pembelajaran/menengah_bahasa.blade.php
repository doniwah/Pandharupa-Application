        ...
        <div class="main-content-dasar">
            ...
            <div class="progress-section-rute-learn">
                ...
                <div class="topic-list-rute-learn">
                    <div class="topic-item-rute-learn" data-route="{{ route('berkenalan-dan-sapa.bahasa') }}">
                    ...
                    <div class="topic-item-rute-learn" data-route="{{ route('berbelanja-pasar.bahasa') }}">
                    ...
                    <div class="topic-item-rute-learn" data-route="{{ route('tanya-transportasi.bahasa') }}">
                        <div class="status-icon-rute-learn"></div>
                        <div class="topic-content-rute-learn">
                    ...
                    <div class="topic-item-rute-learn" data-route="{{ route('makanan-minuman.bahasa') }}">
                        <div class="status-icon-rute-learn"></div>
                        <div class="topic-content-rute-learn">
